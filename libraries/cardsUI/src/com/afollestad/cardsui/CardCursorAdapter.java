...
/**
 * A {@link SilkCursorAdapter} that displays {@link Card} and {@link CardHeader} objects in a {@link CardListView}.
 *
...
public class CardCursorAdapter<ItemType extends CardBase<ItemType> & SilkCursorItem<ItemType>> extends SilkCursorAdapter<ItemType> {
     ...
     */
    public CardCursorAdapter(Context context, int accentColorRes, Class<? extends SilkCursorItem> cls) {
        super(context, cls);
    ...
    private void setupHeader(ItemType header, View view) {
        ...
        subtitle.setTextColor(getContext().getResources().getColor(mTheme == CardTheme.Light ? android.R.color.black : android.R.color.white));
    ...
    protected boolean onProcessContent(TextView content, ItemType card) {
        ...
        content.setTextColor(getContext().getResources().getColor(mTheme == CardTheme.Light ? android.R.color.black : android.R.color.white));
        return false;
    }
